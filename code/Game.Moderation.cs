...
public partial class Game : Sandbox.Game
{
	...
	[ConCmd.Admin( Name = "murder_ban", Help = "Ban the client with the following steam id." )]
	...
	[ConCmd.Admin( Name = "murder_ban_remove", Help = "Remove the ban on a client using a steam id." )]
